...
while(!feof($dados)){
    ...
    if($ufParametro==$uf && $uf!= 'UF'){
        ...
        Número de munícipios: <strong>$quantidade_cidades</strong> | 
        </p>";

        # Definir os porcentuais da população
        ...
        # Nenhuma casa decimal, nenhum separador decimal, uso do ponto como separador de milhar
