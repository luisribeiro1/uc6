    ...
    <div class='col-3'>
                <div class='card mb-3'>
                    <div class='card-body text-center'>
                        <span class='fw-bold'>$uf - $nomeEstado<br></span>
                        <span class='fs-7'>
                            <i class=' bi bi-person-standing text-info'></i> 100%  $homens
                            <i class='  bi bi-person-standing-dress text-danger'></i> 100%  $mulheres
                        </span>
                        <br>
                        <span class='fs-7'>
                            <i class=' bi bi-tree-fill text-success'></i> $urbana 41%
                            <i class=' bi bi-building-fill text-primary'></i>$rural 59%
                        </span>
                        <br>
